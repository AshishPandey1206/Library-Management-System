...
#label and input
        ...
        ttk.Combobox(d, textvariable = w, values=["What is your First mobile number?","What is your favourite movie?","What is your favorite color?","What is the name of the town where yoy were born?","What was your first car?","What is your school name?", "What is your home name?","What is your Father name?", "What is your pet name?"], width=57,state="readonly").place(x=620, y=380)
